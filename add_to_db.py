...
class Database:
    def __init__(self, master, *args, **kwargs):
        self.master = master
        self.master.bind('<Return>', self.get_Entries)  # Bind the Space key to get_Entries
        self.master.bind('<Escape>', self.clear_all)   # Bind the Escape (Esc) key to clear_all
        ...
        self.tBox = Text(master, width=60, height=21,bg="wheat")
...
def main():
    root = Tk()
    b = Database(root)
    root.geometry("1250x500+250+150")
